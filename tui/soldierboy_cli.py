...
def print_monologue(text: str):
    ...
    console.print()
    console.print(f"  [{C_ACCENT}]  ┌─ soldierboy {'─' * 39}[/]")
    console.print()
...
def show_help():
    ...
    console.print(
        f"\n  [{C_DIM}]  Or type anything — Soldier Boy will answer from investigation context.[/]\n"
    )
...
def get_prompt() -> str:
    try:
        sys.stdout.write("\033[38;2;230;59;31m  soldierboy ›\033[0m  ")
        sys.stdout.flush()
        return input().strip()
